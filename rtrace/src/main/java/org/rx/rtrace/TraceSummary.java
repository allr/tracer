...
public class TraceSummary extends Summary {
	...
	static final TraceInfo fields[] = {
		...
		new TraceMultiInfo("AllocatedVectors", new String[]{"tl", "elts", "size"}),
		new TraceMultiInfo("AllocatedSmallVectors", new String[]{"tl", "elts", "size"}),
		new TraceMultiInfo("AllocatedAllVectors", new String[]{"tl", "elts", "size"}),
